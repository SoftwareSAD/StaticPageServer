          ...
          <dl class="movie-list">
            <dd v-for="(movie, index) in movie_list" v-if="index < 30" :key="index">
              <div class="movie-item">
                <a :href="movie.href" target="_blank">
                  <div class="movie-poster">
                    <img :src="movie.img_src" :title="movie.movie_name" >
                  </div>
                </a>
              ...
              <div class="channel-detail movie-item-title" :title="movie.movie_name">
                <a :href="movie.href" :title="movie.movie_name" target="_blank">{{movie.movie_name}}</a>
              </div>
              <div class="channel-detail channel-detail-orange">
                <i class="integer">{{movie.score_front}}.</i>
                <i class="fraction">{{movie.score_back}}</i>
              </div>
            </dd>
          </dl>
        </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        movie_list: [
          {movie_name: "头号玩家", href: '/movie-detail-page', img_src: require("~/assets/img/film/best_player.jpg"), img_alt: "头号玩家", least_price: "23", score_front: "8", score_back: "5"},
          {movie_name: "头号玩家", href: '/movie-detail-page', img_src: require("~/assets/img/film/best_player.jpg"), img_alt: "头号玩家", least_price: "23", score_front: "8", score_back: "5"},
          {movie_name: "头号玩家", href: '/movie-detail-page', img_src: require("~/assets/img/film/best_player.jpg"), img_alt: "头号玩家", least_price: "23", score_front: "8", score_back: "5"},
          {movie_name: "头号玩家", href: '/movie-detail-page', img_src: require("~/assets/img/film/best_player.jpg"), img_alt: "头号玩家", least_price: "23", score_front: "8", score_back: "5"},
          {movie_name: "头号玩家", href: '/movie-detail-page', img_src: require("~/assets/img/film/best_player.jpg"), img_alt: "头号玩家", least_price: "23", score_front: "8", score_back: "5"},
